 ...
 */
public class BlueTrenchRight extends SequentialCommandGroup {
    public BlueTrenchRight(SwerveSubsystem swerveSubsystem, IntakeSubsystem intakeSubsystem, TurretSubsystem turretSubsystem, ShooterSubsystem shooterSubsystem, HoodSubsystem hoodSubsystem, IndexerSubsystem indexerSubsystem) {
                ...
                Commands.defer(() -> {
                    ...
                    return new SequentialCommandGroup(
                            ...
                            new SequentialCommandGroup(
                                    new DriveToPointContinuous(swerveSubsystem, FlipOverYUtil.apply(AllianceFlipUtil.apply(FieldConstants.BLUE_TRENCH_LEFT_TRANSITION_CONTINUOUS)), 0.5 * AUTO_SCALAR),
