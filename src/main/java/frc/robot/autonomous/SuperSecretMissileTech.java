...
public class SuperSecretMissileTech {
    ...
    public SuperSecretMissileTech(SwerveSubsystem swerveSubsystem, IntakeSubsystem intakeSubsystem, IndexerSubsystem indexerSubsystem, ShooterSubsystem shooterSubsystem, HoodSubsystem hoodSubsystem) {
        ...
        superSecretMissileTech.addOption("BLUE TRENCH LEFT", new BlueTrenchLeft(swerveSubsystem, intakeSubsystem, shooterSubsystem, hoodSubsystem, indexerSubsystem));
