...
public class SuperSecretMissileTech {
    ...
    public SuperSecretMissileTech(SwerveSubsystem swerveSubsystem, SwerveDrive swerveDrive, IntakeSubsystem intakeSubsystem, ShooterSubsystem shooterSubsystem) {
        superSecretMissileTech.setDefaultOption("NOTHING", new SequentialCommandGroup());
        superSecretMissileTech.addOption("DEPOT_SHOOT", new DepotShoot(swerveSubsystem, swerveDrive));
    }
