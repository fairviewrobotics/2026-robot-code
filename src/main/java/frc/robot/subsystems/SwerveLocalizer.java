...
public class SwerveLocalizer extends SubsystemBase {
    ...
    public SwerveLocalizer(PhotonCamera[] cameras) {
    ...
    public void periodic() {
        ...
        for (int cameraIndex = 0; cameraIndex < cameraPoses.length; cameraIndex++) {
            ...
            poseEstimator.addVisionMeasurement(robotPoseEstimation, timestamp, VecBuilder.fill(xyStdDev, xyStdDev, thetaStdDev));

        }

    }

    public void addOdometry(Rotation2d gyroAngle, SwerveModulePosition[] swerveModulePositions) {
