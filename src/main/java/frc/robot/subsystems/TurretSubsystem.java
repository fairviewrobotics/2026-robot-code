...
public class TurretSubsystem extends SubsystemBase {
    ...
    public void periodic() {
        ...
        SmartDashboard.putNumber("turret angle", turretMotor.getEncoder().getPosition());
        SmartDashboard.putNumber("turret error", turretPID.getPositionError());
        SmartDashboard.putBoolean("turret linebreak", turretLinebreak.get());
    }
