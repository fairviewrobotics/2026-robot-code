...
public class TurretSubsystem extends SubsystemBase {
    ...
    public void periodic() {
        ...
        Logger.recordOutput("turret angle", turretMotor.getEncoder().getPosition());
        Logger.recordOutput("turret error", turretPID.getPositionError());
        Logger.recordOutput("turret linebreak", turretLinebreak.get());
    }
