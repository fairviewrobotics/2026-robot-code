...
public class FieldConstants {
    ...
    public static final Pose2d BLUE_PASS_RIGHT_POSE = new Pose2d(2.0, 1.4, Rotation2d.kZero);
    public static final Pose2d BLUE_PASS_LEFT_POSE = new Pose2d(2.0, 7.0, Rotation2d.kZero);
