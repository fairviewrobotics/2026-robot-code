...
public class ShootingConstants {
    ...
    public static final double TURRET_GEAR_RATIO = 0.02083333333; // 1 : 40
    ...
    public static final Transform2d TURRET_TRANSFORM_2D = new Transform2d(-0.127, 0.0, Rotation2d.kZero);
